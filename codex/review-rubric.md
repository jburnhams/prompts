<!-- Source: openai/codex, codex-rs/prompts/templates/review/rubric.md.
     Verbatim. This is the system prompt for the nested one-shot review
     conversation ReviewTask spawns; it is unrelated to the guardian
     approval reviewer. -->
