<!-- Source: openai/codex, codex-rs/prompts/templates/permissions/. Verbatim,
     all seven templates. Exactly one sandbox_mode file and one
     approval_policy file render per turn, into the PermissionsState
     world-state section. -->
...
# `approval_policy/on_request_rule_request_permission.md`
