<!-- Source: openai/codex, codex-rs/ext/goal/templates/goals/. Verbatim.
     These are injected as developer-role context fragments by the /goal
     extension, not asked for by the model. `continuation.md` is what the
     harness sends when it re-samples the model on an unfinished goal. -->
