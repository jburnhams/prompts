<!-- Source: openai/codex, codex-rs/models-manager/models.json,
     models[slug="gpt-6-astra"].model_messages.token_budget.
     Verbatim text fields; the numeric fields are quoted inline. -->

Non-text fields for this model: `enabled: false`, `use_history_notes_extension: false`, `reminder_threshold_tokens: 6144`, `auto_compact_fallback_buffer_tokens: 16384`.
