<!-- Source: openai/codex, codex-rs/collaboration-mode-templates/templates/.
     Verbatim. A collaboration mode is set by a developer message carrying
     <collaboration_mode>...</collaboration_mode>; the model catalog may
     override either template per model (see README.md). -->
