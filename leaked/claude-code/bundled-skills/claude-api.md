...
[... truncated for this collection — full file is 11356 lines / 537955 bytes, a large reference doc matching this session's own loaded 'claude-api' skill. Not stored in full here since the bulk is reference material (API docs / settings.json field-by-field documentation) rather than agent-architecture-relevant prompt content. See the repo's own skill for the complete text.]
